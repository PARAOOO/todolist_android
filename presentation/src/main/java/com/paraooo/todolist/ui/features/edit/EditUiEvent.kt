...
sealed class EditUiEvent {
    ...
    data class onTimeInputChanged(val timeInputState: LocalTime?) : EditUiEvent()
    ...
    data class onInit(val instanceId : UUID) : EditUiEvent()
    data class onEditClicked(val instanceId: UUID) : EditUiEvent()
